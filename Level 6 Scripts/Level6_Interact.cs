...
public class Level6_Interact : MonoBehaviour
{
    public GameObject[] parent;
    public Level6Objective assignedObjective;
    ...
    {
        if (actor.CompareTag("Player") && Level6_Manager.instance.currentObjective == assignedObjective)
        {
