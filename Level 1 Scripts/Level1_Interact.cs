...
public class Level1_Interact : MonoBehaviour
{
    public GameObject[] parent;
    public Level1Objective assignedObjective;
    ...
    {
        if (actor.CompareTag("Player") && Level1_Manager.instance.currentObjective == assignedObjective)
        {
