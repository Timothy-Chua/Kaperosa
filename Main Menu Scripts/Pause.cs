...
public class Pause : MonoBehaviour
{
    ...
    [SerializeField] private GameObject panelPause, panelPlay, panelSetting, panelGameOver, panelGameplay;
    ...
    private void Update()
    {
        ...
        if (GameManager.instance.gameState == GameState.Transiton)
        {
            panelGameplay.SetActive(false);
        }
        else if (GameManager.instance.gameState == GameState.Gameplay)
        {
            if (!panelGameplay.activeInHierarchy)
